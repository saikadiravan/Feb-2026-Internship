...
|----------|------------|------|
| Strong | Full skill match, 3+ years experience | 90–100 |
| Average | Partial skills, internship experience | 40–60 |
| Weak | Basic IT background, no core skills | 5–20 |
...
### 🔍 Problem
During testing, weak candidates with basic technical background (e.g., IT graduate) were assigned a score of **0**, which is unrealistic.
